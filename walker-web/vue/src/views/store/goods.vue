...
<!--  定制模拟展示 带附件图片 文件  -->
      <div class="div-all">
          <div class="div-item" v-for="(item, i) in list">
              <p class="name">{{item.NAME | timeAgo }}</p>
//              <img class="image-large" v-lazy="item.IMGS | timeAgo " >

              <div class="div-item-sub">
                  <div class="sub-left">
//                    <img class="image-icon" v-lazy="item.IMGS | timeAgo " >
                    <img class="image-icon" src="/file/download.do?path=3b3f5d5f-bb51-4cfc-b07a-16edebf46f01">
                  </div>
                  <div class="sub-middle">
                      <p class="review-count">{{item.PRICE}} reviews</p> <br>
                      <span>{{item.ABOUT}}</span>  <br>
                  </div>
                  <div class="sub-rigth">
                      <p class="feed-title">
                      <span>The Everlasting Regret</span>
                      </p>
                      <p class="feed-description">{{item.ABOUT}}</p>
                  </div>
              </div>
          </div>
          <div class="clear" ></div>
