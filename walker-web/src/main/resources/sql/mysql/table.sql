...
--DROP TABLE W_MSG_0;
--DROP TABLE W_MSG_1;
CREATE TABLE  IF NOT EXISTS  W_MSG_0 (ID VARCHAR(40) primary key, TEXT TEXT);
CREATE TABLE  IF NOT EXISTS  W_MSG_1 (ID VARCHAR(40) primary key, TEXT TEXT);
...
CREATE TABLE  IF NOT EXISTS  W_MSG_USER_0 (ID VARCHAR(200) primary key, USER_FROM VARCHAR(40), USER_TO VARCHAR(40), MSG_ID VARCHAR(40), TIME VARCHAR(20) );
CREATE TABLE  IF NOT EXISTS  W_MSG_USER_1 (ID VARCHAR(200) primary key, USER_FROM VARCHAR(40), USER_TO VARCHAR(40), MSG_ID VARCHAR(40), TIME VARCHAR(20) );
CREATE TABLE  IF NOT EXISTS  W_MSG_USER_2 (ID VARCHAR(200) primary key, USER_FROM VARCHAR(40), USER_TO VARCHAR(40), MSG_ID VARCHAR(40), TIME VARCHAR(20) );
CREATE TABLE  IF NOT EXISTS  W_MSG_USER_3 (ID VARCHAR(200) primary key, USER_FROM VARCHAR(40), USER_TO VARCHAR(40), MSG_ID VARCHAR(40), TIME VARCHAR(20) );
